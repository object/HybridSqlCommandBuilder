    ...
    internal static class DictionaryExtensions
    {
        ...
        public static object ToObject(this IDictionary<string, object> source, Type type, bool dynamicObject = false)
        {
            ...
            if (typeof(IDictionary<string, object>).IsAssignableFrom(type))
                return source;
            if (type == typeof(IDictionary<string, object>) || type == typeof(object))
        ...
        private static IDictionary<string, object> CreateResultRow(IDictionary<string, object> source, bool dynamicObject = false)
        {
